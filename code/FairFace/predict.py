...
def predidct_age_gender_race(save_prediction_at, imgs_path = 'cropped_faces/'):
    ...
    model_fair_7.load_state_dict(torch.load('fair_face_models/fairface_alldata_20191111.pt',map_location='cpu'))
...
if __name__ == "__main__":
    ...
    predidct_age_gender_race("predict_outputs.csv", SAVE_DETECTED_AT)
